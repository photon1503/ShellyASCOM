...
//
// ASCOM Switch driver for photonShelly
//
...
namespace ASCOM.photonShelly.Switch
{
    ...
    //
    // Your driver's DeviceID is ASCOM.photonShelly.Switch
    //
    // The COM Guid attribute sets the CLSID for ASCOM.photonShelly.Switch
    // The COM ClassInterface/None attribute prevents an empty interface called _photonShelly from being created and used as the [default] interface
    //
    ...
    public class Switch : ReferenceCountedObjectBase, ISwitchV3, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="photonShelly"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Switch()
        {
            try
            {
                ...
                tl = new TraceLogger("", "photonShelly.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show($"{ex.Message}", "Exception creating ASCOM.photonShelly.Switch", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
