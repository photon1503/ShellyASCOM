...
;SignTool=MsSign $f
;Encryption=yes
AppID={{4D982B57-1032-4B99-99A5-D06BCC3A3B96}
AppName=ASCOM Shelly Switch Driver
AppVersion={#myAppVersion}
AppVerName="ASCOM Shelly Switch Driver {#myAppVersion}"
...
OutputDir="."
OutputBaseFilename="Shelly ASCOM Driver {#myAppVersion}"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\Shelly"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\Shelly"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\git\ShellyASCOM\bin\Release\ASCOM.photonShelly.exe"; DestDir: "{app}"
;Source: "C:\Users\geraldhitz\source\repos\ShellyASCOM\bin\Release\ASCOM.photonShelly.exe"; DestDir: "{app}"

[Run]

; Only for .NET local-server drivers
Filename: "{app}\\ASCOM.photonShelly.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\\ASCOM.photonShelly.exe"; Parameters: "/unregister"
